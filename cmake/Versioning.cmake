...
function(mw_extract_version)
    ...
    if(ARG_OUT_MAJOR)
        set(${ARG_OUT_MAJOR} "${_major}" PARENT_SCOPE)
    endif()
    if(ARG_OUT_MINOR)
        set(${ARG_OUT_MINOR} "${_minor}" PARENT_SCOPE)
    endif()
    if(ARG_OUT_PATCH)
        set(${ARG_OUT_PATCH} "${_patch}" PARENT_SCOPE)
    endif()
    if(ARG_OUT_TWEAK)
        set(${ARG_OUT_TWEAK} "${_tweak}" PARENT_SCOPE)
    endif()
    if(ARG_OUT_FULL)
        set(${ARG_OUT_FULL} "${_full}" PARENT_SCOPE)
    endif()
